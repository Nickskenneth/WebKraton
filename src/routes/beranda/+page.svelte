<script>
	...
	import ButtonLihatSemua from '$lib/components/ButtonLihatSemua.svelte';
...
<section class="py-10 px-5 bg-gray-100">
	<h2 class="text-2xl font-bold text-blue-600 font-poppins text-center mb-6">Tentang Kraton Solo</h2>
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-center max-w-screen-lg mx-auto">
		<CardAbout
